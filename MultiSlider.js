...
export default class MultiSlider extends React.Component {
  ...
  moveOne = gestureState => {
    ...
    const unconfined = (!this.props.LTR && I18nManager.isRTL) ? this.state.pastOne - gestureState.dx : gestureState.dx + this.state.pastOne;
    var bottom = 0;
  ...
  render() {
    ...
    // const sliderColor = this.props.containerArrColors
    // const colors = 
    return (
